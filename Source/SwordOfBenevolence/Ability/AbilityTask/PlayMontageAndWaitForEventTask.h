...
#include "PlayMontageAndWaitForEventTask.generated.h"
 ...
 */
UCLASS()
class SWORDOFBENEVOLENCE_API UPlayMontageAndWaitForEventTask : public UAbilityTask
{
	GENERATED_BODY()

public:
	// Constructor and overrides
	UPlayMontageAndWaitForEventTask(const FObjectInitializer& ObjectInitializer);
